...
// WAP to count no. of nodes in circular singly linked list
#include <stdio.h>
#include <stdlib.h>
...
// function to insert an element in the singly circular linked list at the begining
...
// WAP to delete the last node of a singly circular linked list
